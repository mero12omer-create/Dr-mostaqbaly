...
const weeklyPlan = [
  { key: "sat", name: "السبت", tasks: [...schoolRoutine, { time: "بعد ٢:٠٠", title: "علوم", note: "مذاكرة وحل التدريبات", type: "teal", id: "sat-science" }, { time: "٤:٣٠ – ٥:٣٠", title: "الجيم", note: "تمرين كامل للجسم", type: "blue", id: "sat-gym" }, sleepRoutine] },
  { key: "sun", name: "الأحد", tasks: [...schoolRoutine, { time: "٢:٠٠ – ٦:٠٠", title: "فلسفة ومنطق", note: "مذاكرة مركزة", type: "teal", id: "sun-philosophy" }, { time: "بعد ٦:٠٠", title: "نحو", note: "مذاكرة المادة", type: "teal", id: "sun-grammar" }, sleepRoutine] },
  { key: "mon", name: "الاثنين", tasks: [...schoolRoutine, { time: "قبل ٤:٠٠", title: "تجهيز لدرس الرياضة", note: "راحة أو تحضير", type: "gray" }, { time: "٤:٠٠", title: "درس رياضة", note: "موعد الدرس", type: "blue", id: "mon-math" }, { time: "بعد الدرس", title: "أدب / نصوص / قراءة", note: "حسب المحاضرة", type: "teal", id: "mon-arabic" }, { time: "٦:٠٠ – ٧:٠٠", title: "الجيم", note: "تمرين خفيف", type: "blue", id: "mon-gym" }, { time: "٩:٠٠ م", title: "درس إنجليزي", note: "لا مذاكرة ثقيلة بعده", type: "blue", id: "mon-english-class" }, sleepRoutine] },
  ...
  { key: "wed", name: "الأربعاء", tasks: [...schoolRoutine, { time: "مهمة اليوم", title: "تسليم واجب العربي", note: "موعد التسليم", type: "orange", id: "wed-arabic" }, { time: "٤:٠٠ – ٥:٠٠", title: "الجيم", note: "تمرين كامل للجسم", type: "blue", id: "wed-gym" }, { time: "بعد ٥:٠٠", title: "مراجعة أو راحة", note: "حسب احتياجك", type: "gray", id: "wed-flex" }, sleepRoutine] },
  ...
  { key: "fri", name: "الجمعة", tasks: [{ time: "٢:٠٠ – ٤:٠٠", title: "إنجليزي — مهمة أساسية", note: "مذاكرة إجبارية", type: "teal", id: "fri-english" }, { time: "٤:٣٠ – ٥:٣٠", title: "الجيم", note: "تمرين كامل أو كارديو خفيف", type: "blue", id: "fri-gym" }, { time: "بعد ٥:٣٠", title: "مراجعة أو خروج", note: "وقت راحة مفتوح", type: "gray", id: "fri-flex" }, sleepRoutine] }
];
